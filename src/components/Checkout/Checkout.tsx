              ...
              >
                <div className="accordion-item upi">
                  <h2 className="accordion-header custom-control custom-radio d-flex align-items-center">
                    ...
                    >
                      <label className=" fw-bold fs-4  " htmlFor="customRadio1">
                        UPI
                      </label>
                    </div>
                  </h2>
                    ...
                    <div className="accordion-body">
                      <div className="row justify-content-between">
                        <div className="col-12 col-md-5 d-flex flex-column p-">
                          ...
                          <label htmlFor="upi-id" className="fw-bold fs-4 mb-2">
                            UPI ID / VPA
                          </label>
                          <input
                            className="p-3"
                      ...
                      <div className="row">
                        ...
                        <div className="row mb-4 pe-0">
                          <div className="col-12 col-sm-6 d-flex flex-column mb-4 mb-sm-0">
                            <label className="fw-bold fs-4 mb-3" htmlFor="cvv">
                              CVC / CVV
                            </label>
                            <input
                              className="fs-4 p-3"
                ...
                <div className="accordion-item">
                  <h2 className="accordion-header custom-control custom-radio">
                    ...
                    >
                      <label className=" fw-bold fs-4  " htmlFor="customRadio3">
                        Net Banking
                      </label>
                    </div>
                  </h2>
                  ...
                  >
                    <div className="accordion-body">
                      <p className="fs-4">
                        ...
                        you over to Adyen's secure servers.
                      </p>
                      <select
                        className="fs-4"
                ...
                <div className="accordion-item">
                  <h2 className="accordion-header custom-control custom-radio wallets ">
                    ...
                    >
                      <label className=" fw-bold fs-4  " htmlFor="customRadio4">
                        Mobile Wallets
                      </label>
                    </div>
                  </h2>
